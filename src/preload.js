...
contextBridge.exposeInMainWorld("petAPI", {
  ...
  getAge: () => ipcRenderer.invoke("pet:get-age"),
  setAge: (age) => ipcRenderer.invoke("pet:set-age", age),
  ...
  onAgeChanged: (callback) => ipcRenderer.on("pet:age-changed", (_, age) => callback(age))
});
